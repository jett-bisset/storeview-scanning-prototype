...
const mockScanDetails = {
    ...
    3: {
        ...
        products: [
            // Pickles - Dill
            { id: 'P400001', name: 'Vlasic Kosher Dill Spears 24oz', brand: 'Vlasic', availability: 'in-stock', facings: 6, images: 3, emoji: '🥒' },
            { id: 'P400002', name: 'Vlasic Kosher Dill Whole Pickles 32oz', brand: 'Vlasic', availability: 'in-stock', facings: 2, images: 2, emoji: '🥒' },
            { id: 'P400003', name: 'Vlasic Kosher Dill Chips 16oz', brand: 'Vlasic', availability: 'in-stock', facings: 7, images: 2, emoji: '🥒' },
            { id: 'P400004', name: 'Vlasic Snack\'Mms Kosher Dill 3.5oz', brand: 'Vlasic', availability: 'in-stock', facings: 1, images: 2, emoji: '🥒' },
            { id: 'P400005', name: 'Claussen Kosher Dill Spears 24oz', brand: 'Claussen', availability: 'in-stock', facings: 3, images: 3, emoji: '🥒' },
            { id: 'P400006', name: 'Claussen Kosher Dill Halves 32oz', brand: 'Claussen', availability: 'in-stock', facings: 3, images: 2, emoji: '🥒' },
            { id: 'P400007', name: 'Claussen Kosher Dill Minis 20oz', brand: 'Claussen', availability: 'out-of-stock', facings: 0, images: 1, emoji: '🥒' },
            { id: 'P400008', name: 'Mt. Olive Kosher Dill Spears 24oz', brand: 'Mt. Olive', availability: 'in-stock', facings: 3, images: 2, emoji: '🥒' },
            { id: 'P400009', name: 'Mt. Olive Kosher Baby Dills 16oz', brand: 'Mt. Olive', availability: 'in-stock', facings: 2, images: 2, emoji: '🥒' },
            { id: 'P400010', name: 'Signature SELECT Kosher Dill Spears 24oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 5, images: 2, emoji: '🥒' },
            { id: 'P400011', name: 'Signature SELECT Kosher Dill Whole 32oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 2, images: 2, emoji: '🥒' },
            { id: 'P400012', name: 'Signature SELECT Kosher Dill Chips 16oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 5, images: 2, emoji: '🥒' },

            // Pickles - Bread & Butter
            { id: 'P400013', name: 'Vlasic Bread & Butter Chips 24oz', brand: 'Vlasic', availability: 'in-stock', facings: 3, images: 3, emoji: '🥒' },
            { id: 'P400014', name: 'Vlasic Bread & Butter Spears 24oz', brand: 'Vlasic', availability: 'in-stock', facings: 3, images: 2, emoji: '🥒' },
            { id: 'P400015', name: 'Claussen Bread & Butter Chips 20oz', brand: 'Claussen', availability: 'in-stock', facings: 3, images: 2, emoji: '🥒' },
            { id: 'P400016', name: 'Mt. Olive Bread & Butter Chips 24oz', brand: 'Mt. Olive', availability: 'in-stock', facings: 1, images: 2, emoji: '🥒' },
            { id: 'P400017', name: 'Signature SELECT Bread & Butter Chips 24oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 3, images: 2, emoji: '🥒' },
            { id: 'P400018', name: 'Wickles Wicked Spicy Pickles 16oz', brand: 'Wickles', availability: 'in-stock', facings: 2, images: 2, emoji: '🥒' },

            // Pickles - Sweet & Other Varieties
            { id: 'P400019', name: 'Mt. Olive Sweet Gherkins 16oz', brand: 'Mt. Olive', availability: 'in-stock', facings: 1, images: 2, emoji: '🥒' },
            { id: 'P400020', name: 'Mt. Olive Sweet Relish 10oz', brand: 'Mt. Olive', availability: 'in-stock', facings: 5, images: 2, emoji: '🥒' },
            { id: 'P400021', name: 'Vlasic Sweet Gherkins 16oz', brand: 'Vlasic', availability: 'in-stock', facings: 2, images: 2, emoji: '🥒' },
            { id: 'P400022', name: 'Vlasic Zesty Dill Spears 24oz', brand: 'Vlasic', availability: 'out-of-stock', facings: 0, images: 1, emoji: '🥒' },
            { id: 'P400023', name: 'Signature SELECT Sweet Relish 10oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 2, images: 2, emoji: '🥒' },
            { id: 'P400024', name: 'Signature SELECT Dill Relish 10oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 1, images: 2, emoji: '🥒' },
            { id: 'P400025', name: 'Bubbies Kosher Dill Pickles 33oz', brand: 'Bubbies', availability: 'in-stock', facings: 3, images: 2, emoji: '🥒' },
            { id: 'P400026', name: 'Bubbies Bread & Butter Pickles 25oz', brand: 'Bubbies', availability: 'in-stock', facings: 4, images: 2, emoji: '🥒' },

            // Olives - Black
            { id: 'P400027', name: 'Lindsay Sliced Black Olives 6oz', brand: 'Lindsay', availability: 'in-stock', facings: 2, images: 3, emoji: '🫒' },
            { id: 'P400028', name: 'Lindsay Whole Pitted Black Olives 6oz', brand: 'Lindsay', availability: 'in-stock', facings: 3, images: 3, emoji: '🫒' },
            { id: 'P400029', name: 'Lindsay Sliced Black Olives 2.25oz', brand: 'Lindsay', availability: 'in-stock', facings: 2, images: 2, emoji: '🫒' },
            { id: 'P400030', name: 'Lindsay Whole Pitted Black Olives 2.25oz', brand: 'Lindsay', availability: 'in-stock', facings: 1, images: 2, emoji: '🫒' },
            { id: 'P400031', name: 'Lindsay Large Pitted Black Olives 6oz', brand: 'Lindsay', availability: 'in-stock', facings: 3, images: 2, emoji: '🫒' },
            { id: 'P400032', name: 'Signature SELECT Sliced Black Olives 6oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 4, images: 2, emoji: '🫒' },
            { id: 'P400033', name: 'Signature SELECT Whole Black Olives 6oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 3, images: 2, emoji: '🫒' },
            ...
            { id: 'P400035', name: 'Cento Sliced Black Olives 6oz', brand: 'CENTO', availability: 'in-stock', facings: 1, images: 2, emoji: '🫒' },
            { id: 'P400036', name: 'Cento Whole Black Olives 6oz', brand: 'CENTO', availability: 'in-stock', facings: 4, images: 2, emoji: '🫒' },

            // Olives - Green
            { id: 'P400037', name: 'Mezzetta Spanish Green Olives 10oz', brand: 'Mezzetta', availability: 'in-stock', facings: 3, images: 2, emoji: '🫒' },
            { id: 'P400038', name: 'Mezzetta Garlic Stuffed Olives 10oz', brand: 'Mezzetta', availability: 'in-stock', facings: 1, images: 2, emoji: '🫒' },
            { id: 'P400039', name: 'Mezzetta Pimento Stuffed Olives 10oz', brand: 'Mezzetta', availability: 'in-stock', facings: 3, images: 2, emoji: '🫒' },
            { id: 'P400040', name: 'Mezzetta Jalapeno Stuffed Olives 10oz', brand: 'Mezzetta', availability: 'in-stock', facings: 3, images: 2, emoji: '🫒' },
            { id: 'P400041', name: 'Signature SELECT Green Olives Pimento 10oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 3, images: 2, emoji: '🫒' },
            { id: 'P400042', name: 'Signature SELECT Green Olives Plain 10oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 5, images: 2, emoji: '🫒' },
            { id: 'P400043', name: 'Cento Pimento Stuffed Olives 7oz', brand: 'CENTO', availability: 'in-stock', facings: 1, images: 2, emoji: '🫒' },
            { id: 'P400044', name: 'Goya Manzanilla Olives Pimento 10oz', brand: 'Goya', availability: 'in-stock', facings: 1, images: 2, emoji: '🫒' },
            ...
            { id: 'P400046', name: 'Peloponnese Kalamata Olives 7.9oz', brand: 'Peloponnese', availability: 'in-stock', facings: 1, images: 3, emoji: '🫒' },
            { id: 'P400047', name: 'Peloponnese Pitted Kalamata 7.9oz', brand: 'Peloponnese', availability: 'in-stock', facings: 4, images: 2, emoji: '🫒' },
            { id: 'P400048', name: 'DeLallo Kalamata Olives 9oz', brand: 'DeLallo', availability: 'in-stock', facings: 3, images: 2, emoji: '🫒' },
            { id: 'P400049', name: 'DeLallo Pitted Kalamata Olives 9oz', brand: 'DeLallo', availability: 'in-stock', facings: 4, images: 2, emoji: '🫒' },
            { id: 'P400050', name: 'Cento Kalamata Olives 7oz', brand: 'CENTO', availability: 'in-stock', facings: 2, images: 2, emoji: '🫒' },
            { id: 'P400051', name: 'Signature SELECT Kalamata Olives 8oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 3, images: 2, emoji: '🫒' },
            { id: 'P400052', name: 'Jeff\'s Naturals Kalamata Olives 12oz', brand: 'Jeff\'s Naturals', availability: 'in-stock', facings: 4, images: 2, emoji: '🫒' },
            { id: 'P400053', name: 'Jeff\'s Naturals Castelvetrano Olives 7oz', brand: 'Jeff\'s Naturals', availability: 'in-stock', facings: 2, images: 2, emoji: '🫒' },
            { id: 'P400054', name: 'Mezzetta Kalamata Olives 9.5oz', brand: 'Mezzetta', availability: 'in-stock', facings: 2, images: 2, emoji: '🫒' },
            { id: 'P400055', name: 'Divina Kalamata Olives 6oz', brand: 'Divina', availability: 'in-stock', facings: 4, images: 2, emoji: '🫒' },

            // Artichoke Hearts
            { id: 'P400056', name: 'Cento Artichoke Hearts 14oz', brand: 'CENTO', availability: 'in-stock', facings: 4, images: 3, emoji: '🌿' },
            { id: 'P400057', name: 'Cento Artichoke Quarters 14oz', brand: 'CENTO', availability: 'in-stock', facings: 4, images: 3, emoji: '🌿' },
            { id: 'P400058', name: 'Cento Marinated Artichokes 12oz', brand: 'CENTO', availability: 'in-stock', facings: 3, images: 3, emoji: '🌿' },
            { id: 'P400059', name: 'Cento Grilled Artichokes 10oz', brand: 'CENTO', availability: 'in-stock', facings: 1, images: 2, emoji: '🌿' },
            { id: 'P400060', name: 'Signature SELECT Artichoke Hearts 14oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 2, images: 2, emoji: '🌿' },
            { id: 'P400061', name: 'Signature SELECT Artichoke Quarters 14oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 4, images: 2, emoji: '🌿' },
            ...
            { id: 'P400063', name: 'DeLallo Artichoke Hearts 14oz', brand: 'DeLallo', availability: 'in-stock', facings: 3, images: 2, emoji: '🌿' },
            { id: 'P400064', name: 'DeLallo Marinated Artichokes 12oz', brand: 'DeLallo', availability: 'in-stock', facings: 4, images: 2, emoji: '🌿' },
            { id: 'P400065', name: 'Reese Artichoke Hearts 14oz', brand: 'Reese', availability: 'in-stock', facings: 2, images: 2, emoji: '🌿' },
            { id: 'P400066', name: 'Reese Artichoke Bottoms 14oz', brand: 'Reese', availability: 'in-stock', facings: 3, images: 2, emoji: '🌿' },
            { id: 'P400067', name: 'Cara Mia Marinated Artichokes 14oz', brand: 'Cara Mia', availability: 'in-stock', facings: 4, images: 2, emoji: '🌿' },

            // Roasted Red Peppers
            { id: 'P400068', name: 'Cento Roasted Red Peppers 12oz', brand: 'CENTO', availability: 'in-stock', facings: 4, images: 3, emoji: '🫑' },
            { id: 'P400069', name: 'Cento Fire Roasted Peppers 12oz', brand: 'CENTO', availability: 'in-stock', facings: 5, images: 2, emoji: '🫑' },
            { id: 'P400070', name: 'Cento Roasted Red Pepper Strips 12oz', brand: 'CENTO', availability: 'in-stock', facings: 4, images: 2, emoji: '🫑' },
            { id: 'P400071', name: 'Signature SELECT Roasted Red Peppers 12oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 4, images: 2, emoji: '🫑' },
            { id: 'P400072', name: 'DeLallo Roasted Red Peppers 12oz', brand: 'DeLallo', availability: 'in-stock', facings: 1, images: 2, emoji: '🫑' },
            { id: 'P400073', name: 'DeLallo Fire Roasted Peppers 7.5oz', brand: 'DeLallo', availability: 'in-stock', facings: 4, images: 2, emoji: '🫑' },
            { id: 'P400074', name: 'Mezzetta Roasted Bell Peppers 16oz', brand: 'Mezzetta', availability: 'in-stock', facings: 3, images: 2, emoji: '🫑' },
            { id: 'P400075', name: 'Mancini Roasted Peppers 12oz', brand: 'Mancini', availability: 'out-of-stock', facings: 0, images: 1, emoji: '🫑' },
            { id: 'P400076', name: 'Divina Roasted Red Peppers 10oz', brand: 'Divina', availability: 'in-stock', facings: 2, images: 2, emoji: '🫑' },
            { id: 'P400077', name: 'Jeff\'s Naturals Roasted Peppers 12oz', brand: 'Jeff\'s Naturals', availability: 'in-stock', facings: 2, images: 2, emoji: '🫑' },

            // Pepperoncini & Banana Peppers
            { id: 'P400078', name: 'Mezzetta Golden Pepperoncini 16oz', brand: 'Mezzetta', availability: 'in-stock', facings: 4, images: 3, emoji: '🌶️' },
            { id: 'P400079', name: 'Mezzetta Deli-Sliced Hot Peppers 16oz', brand: 'Mezzetta', availability: 'in-stock', facings: 3, images: 2, emoji: '🌶️' },
            { id: 'P400080', name: 'Signature SELECT Pepperoncini 16oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 4, images: 2, emoji: '🌶️' },
            { id: 'P400081', name: 'Signature SELECT Banana Peppers 16oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 5, images: 2, emoji: '🌶️' },
            { id: 'P400082', name: 'Vlasic Pepperoncini 12oz', brand: 'Vlasic', availability: 'in-stock', facings: 4, images: 2, emoji: '🌶️' },
            { id: 'P400083', name: 'Vlasic Banana Peppers 12oz', brand: 'Vlasic', availability: 'in-stock', facings: 3, images: 2, emoji: '🌶️' },
            { id: 'P400084', name: 'Cento Hot Peppers 12oz', brand: 'CENTO', availability: 'in-stock', facings: 3, images: 2, emoji: '🌶️' },
            { id: 'P400085', name: 'Cento Pepperoncini 16oz', brand: 'CENTO', availability: 'out-of-stock', facings: 0, images: 1, emoji: '🌶️' },
            { id: 'P400086', name: 'Mt. Olive Pepperoncini 16oz', brand: 'Mt. Olive', availability: 'in-stock', facings: 5, images: 2, emoji: '🌶️' },
            { id: 'P400087', name: 'B&G Pepperoncini 16oz', brand: 'B&G', availability: 'in-stock', facings: 4, images: 2, emoji: '🌶️' },

            // Jalapeños
            { id: 'P400088', name: 'La Costeña Jalapeño Slices 12oz', brand: 'La Costeña', availability: 'in-stock', facings: 3, images: 2, emoji: '🌶️' },
            { id: 'P400089', name: 'La Costeña Whole Jalapeños 12oz', brand: 'La Costeña', availability: 'in-stock', facings: 3, images: 2, emoji: '🌶️' },
            { id: 'P400090', name: 'Signature SELECT Sliced Jalapeños 12oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 4, images: 2, emoji: '🌶️' },
            { id: 'P400091', name: 'Mezzetta Sliced Jalapeños 16oz', brand: 'Mezzetta', availability: 'in-stock', facings: 1, images: 2, emoji: '🌶️' },
            { id: 'P400092', name: 'Goya Jalapeño Peppers 12oz', brand: 'Goya', availability: 'in-stock', facings: 2, images: 2, emoji: '🌶️' },
            { id: 'P400093', name: 'Ortega Diced Jalapeños 4oz', brand: 'Ortega', availability: 'in-stock', facings: 4, images: 2, emoji: '🌶️' },

            // Capers
            { id: 'P400094', name: 'Cento Capers Non-Pareil 3.5oz', brand: 'CENTO', availability: 'in-stock', facings: 5, images: 2, emoji: '🌱' },
            { id: 'P400095', name: 'Cento Capers Capote 3.5oz', brand: 'CENTO', availability: 'in-stock', facings: 3, images: 2, emoji: '🌱' },
            { id: 'P400096', name: 'Signature SELECT Capers 3.5oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 2, images: 2, emoji: '🌱' },
            { id: 'P400097', name: 'DeLallo Capers Non-Pareil 3.5oz', brand: 'DeLallo', availability: 'in-stock', facings: 3, images: 2, emoji: '🌱' },
            { id: 'P400098', name: 'Mezzetta Imported Capers 4oz', brand: 'Mezzetta', availability: 'out-of-stock', facings: 0, images: 1, emoji: '🌱' },
            { id: 'P400099', name: 'Divina Capers 3.5oz', brand: 'Divina', availability: 'in-stock', facings: 2, images: 2, emoji: '🌱' },
            { id: 'P400100', name: 'Reese Capers Non-Pareil 3.5oz', brand: 'Reese', availability: 'in-stock', facings: 3, images: 2, emoji: '🌱' },

            // Sun-Dried Tomatoes
            { id: 'P400101', name: 'Cento Sun-Dried Tomatoes in Oil 8oz', brand: 'CENTO', availability: 'in-stock', facings: 2, images: 2, emoji: '🍅' },
            { id: 'P400102', name: 'Cento Julienne Sun-Dried Tomatoes 8oz', brand: 'CENTO', availability: 'in-stock', facings: 4, images: 2, emoji: '🍅' },
            { id: 'P400103', name: 'Signature SELECT Sun-Dried Tomatoes 8oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 1, images: 2, emoji: '🍅' },
            { id: 'P400104', name: 'DeLallo Sun-Dried Tomatoes 7oz', brand: 'DeLallo', availability: 'in-stock', facings: 3, images: 2, emoji: '🍅' },
            { id: 'P400105', name: 'Mezzetta Sun-Dried Tomatoes 8oz', brand: 'Mezzetta', availability: 'in-stock', facings: 2, images: 2, emoji: '🍅' },
            { id: 'P400106', name: 'Bella Sun Luci Sun-Dried Tomatoes 3oz', brand: 'Bella Sun Luci', availability: 'in-stock', facings: 2, images: 2, emoji: '🍅' },
            ...
            { id: 'P400108', name: 'Sable & Rosenfeld Cocktail Onions 10oz', brand: 'Sable & Rosenfeld', availability: 'in-stock', facings: 3, images: 2, emoji: '🧅' },
            { id: 'P400109', name: 'Signature SELECT Cocktail Onions 8oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 4, images: 2, emoji: '🧅' },
            { id: 'P400110', name: 'Mezzetta Cocktail Onions 10oz', brand: 'Mezzetta', availability: 'in-stock', facings: 6, images: 2, emoji: '🧅' },
            { id: 'P400111', name: 'Cento Pearl Onions 15oz', brand: 'CENTO', availability: 'in-stock', facings: 1, images: 2, emoji: '🧅' },

            // Marinated Vegetables
            { id: 'P400112', name: 'Cento Marinated Mushrooms 12oz', brand: 'CENTO', availability: 'in-stock', facings: 2, images: 2, emoji: '🍄' },
            { id: 'P400113', name: 'Signature SELECT Marinated Mushrooms 12oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 3, images: 2, emoji: '🍄' },
            { id: 'P400114', name: 'DeLallo Marinated Mushrooms 10oz', brand: 'DeLallo', availability: 'in-stock', facings: 5, images: 2, emoji: '🍄' },
            { id: 'P400115', name: 'Cento Eggplant Caponata 11.5oz', brand: 'CENTO', availability: 'in-stock', facings: 3, images: 2, emoji: '🍆' },
            { id: 'P400116', name: 'Cento Grilled Eggplant 10oz', brand: 'CENTO', availability: 'out-of-stock', facings: 0, images: 1, emoji: '🍆' },
            { id: 'P400117', name: 'DeLallo Eggplant Caponata 7.05oz', brand: 'DeLallo', availability: 'in-stock', facings: 1, images: 2, emoji: '🍆' },

            // Antipasto & Mixed Vegetables
            { id: 'P400118', name: 'Mezzetta Italian Antipasto 16oz', brand: 'Mezzetta', availability: 'in-stock', facings: 4, images: 2, emoji: '🥗' },
            { id: 'P400119', name: 'Signature SELECT Giardiniera 16oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 4, images: 2, emoji: '🥗' },
            { id: 'P400120', name: 'Cento Hot Giardiniera 16oz', brand: 'CENTO', availability: 'in-stock', facings: 3, images: 2, emoji: '🥗' },
            { id: 'P400121', name: 'Cento Mild Giardiniera 16oz', brand: 'CENTO', availability: 'in-stock', facings: 3, images: 2, emoji: '🥗' },
            { id: 'P400122', name: 'Vienna Beef Hot Giardiniera 16oz', brand: 'Vienna Beef', availability: 'in-stock', facings: 4, images: 2, emoji: '🥗' },
            { id: 'P400123', name: 'DeLallo Giardiniera 16oz', brand: 'DeLallo', availability: 'in-stock', facings: 1, images: 2, emoji: '🥗' },

            // Pimentos
            { id: 'P400124', name: 'Dromedary Diced Pimentos 4oz', brand: 'Dromedary', availability: 'in-stock', facings: 5, images: 2, emoji: '🫑' },
            { id: 'P400125', name: 'Signature SELECT Diced Pimentos 4oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 1, images: 2, emoji: '🫑' },
            { id: 'P400126', name: 'Cento Diced Pimentos 4oz', brand: 'CENTO', availability: 'in-stock', facings: 2, images: 2, emoji: '🫑' },

            // Sauerkraut
            { id: 'P400127', name: 'Vlasic Sauerkraut 32oz', brand: 'Vlasic', availability: 'in-stock', facings: 3, images: 2, emoji: '🥬' },
            { id: 'P400128', name: 'Signature SELECT Sauerkraut 32oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 6, images: 2, emoji: '🥬' },
            { id: 'P400129', name: 'Claussen Sauerkraut 32oz', brand: 'Claussen', availability: 'out-of-stock', facings: 0, images: 1, emoji: '🥬' },
            { id: 'P400130', name: 'Frank\'s Kraut 14oz', brand: 'Frank\'s', availability: 'in-stock', facings: 7, images: 2, emoji: '🥬' },

            // Horseradish
            { id: 'P400131', name: 'Gold\'s Prepared Horseradish 8oz', brand: 'Gold\'s', availability: 'in-stock', facings: 1, images: 2, emoji: '🌱' },
            { id: 'P400132', name: 'Signature SELECT Horseradish 8oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 2, images: 2, emoji: '🌱' },
            { id: 'P400133', name: 'Silver Spring Horseradish 9.5oz', brand: 'Silver Spring', availability: 'in-stock', facings: 3, images: 2, emoji: '🌱' },

            // Olive Salad & Tapenade
            { id: 'P400134', name: 'Boscoli Italian Olive Salad 16oz', brand: 'Boscoli', availability: 'in-stock', facings: 2, images: 2, emoji: '🫒' },
            { id: 'P400135', name: 'Mezzetta Olive Bruschetta 9.5oz', brand: 'Mezzetta', availability: 'in-stock', facings: 4, images: 2, emoji: '🫒' },
            { id: 'P400136', name: 'DeLallo Black Olive Tapenade 6.35oz', brand: 'DeLallo', availability: 'in-stock', facings: 2, images: 2, emoji: '🫒' },
            { id: 'P400137', name: 'DeLallo Green Olive Tapenade 6.35oz', brand: 'DeLallo', availability: 'out-of-stock', facings: 0, images: 1, emoji: '🫒' },
            { id: 'P400138', name: 'Divina Olive Tapenade 9oz', brand: 'Divina', availability: 'in-stock', facings: 3, images: 2, emoji: '🫒' },

            // Cherry Peppers & Other Peppers
            { id: 'P400139', name: 'Cento Sweet Cherry Peppers 12oz', brand: 'CENTO', availability: 'in-stock', facings: 3, images: 2, emoji: '🫑' },
            { id: 'P400140', name: 'Cento Hot Cherry Peppers 12oz', brand: 'CENTO', availability: 'in-stock', facings: 1, images: 2, emoji: '🫑' },
            { id: 'P400141', name: 'Mezzetta Hot Cherry Peppers 16oz', brand: 'Mezzetta', availability: 'in-stock', facings: 1, images: 2, emoji: '🫑' },
            { id: 'P400142', name: 'B&G Hot Cherry Peppers 12oz', brand: 'B&G', availability: 'in-stock', facings: 1, images: 2, emoji: '🫑' },
            { id: 'P400143', name: 'Jeff\'s Naturals Sliced Cherry Peppers 12oz', brand: 'Jeff\'s Naturals', availability: 'in-stock', facings: 1, images: 2, emoji: '🫑' },

            // Pickled Beets
            { id: 'P400144', name: 'Signature SELECT Pickled Beets 16oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 3, images: 2, emoji: '🥬' },
            { id: 'P400145', name: 'Aunt Nellie\'s Pickled Beets 16oz', brand: 'Aunt Nellie\'s', availability: 'in-stock', facings: 3, images: 2, emoji: '🥬' },
            { id: 'P400146', name: 'Del Monte Pickled Beets 16oz', brand: 'Del Monte', availability: 'out-of-stock', facings: 0, images: 1, emoji: '🥬' },

            // Water Chestnuts
            { id: 'P400147', name: 'Dynasty Sliced Water Chestnuts 8oz', brand: 'Dynasty', availability: 'in-stock', facings: 3, images: 2, emoji: '🥜' },
            { id: 'P400148', name: 'Dynasty Whole Water Chestnuts 8oz', brand: 'Dynasty', availability: 'in-stock', facings: 3, images: 2, emoji: '🥜' },
            { id: 'P400149', name: 'La Choy Water Chestnuts 8oz', brand: 'La Choy', availability: 'in-stock', facings: 2, images: 2, emoji: '🥜' },

            // Bamboo Shoots
            { id: 'P400150', name: 'Dynasty Bamboo Shoots Sliced 8oz', brand: 'Dynasty', availability: 'in-stock', facings: 2, images: 2, emoji: '🎋' },
            { id: 'P400151', name: 'Dynasty Bamboo Shoots Whole 8oz', brand: 'Dynasty', availability: 'in-stock', facings: 3, images: 2, emoji: '🎋' },
            { id: 'P400152', name: 'La Choy Bamboo Shoots 8oz', brand: 'La Choy', availability: 'in-stock', facings: 2, images: 2, emoji: '🎋' },

            // Hearts of Palm
            { id: 'P400153', name: 'Goya Hearts of Palm 14oz', brand: 'Goya', availability: 'in-stock', facings: 3, images: 2, emoji: '🌴' },
            { id: 'P400154', name: 'Native Forest Hearts of Palm 14oz', brand: 'Native Forest', availability: 'in-stock', facings: 2, images: 2, emoji: '🌴' },
            ...
            // Canned Asparagus
            { id: 'P400156', name: 'Del Monte Asparagus Spears 15oz', brand: 'Del Monte', availability: 'in-stock', facings: 1, images: 2, emoji: '🌿' },
            { id: 'P400157', name: 'Signature SELECT Asparagus Cuts 15oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 1, images: 2, emoji: '🌿' },

            // Canned Peas
            { id: 'P400158', name: 'Le Sueur Sweet Peas 15oz', brand: 'Le Sueur', availability: 'in-stock', facings: 3, images: 2, emoji: '🫛' },
            { id: 'P400159', name: 'Green Giant Sweet Peas 15oz', brand: 'Green Giant', availability: 'in-stock', facings: 4, images: 2, emoji: '🫛' },
            { id: 'P400160', name: 'Signature SELECT Sweet Peas 15oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 5, images: 2, emoji: '🫛' },
            { id: 'P400161', name: 'Del Monte Sweet Peas 15oz', brand: 'Del Monte', availability: 'in-stock', facings: 7, images: 2, emoji: '🫛' },

            // Canned Corn
            { id: 'P400162', name: 'Green Giant Whole Kernel Corn 15oz', brand: 'Green Giant', availability: 'in-stock', facings: 3, images: 2, emoji: '🌽' },
            { id: 'P400163', name: 'Green Giant Cream Style Corn 15oz', brand: 'Green Giant', availability: 'in-stock', facings: 3, images: 2, emoji: '🌽' },
            { id: 'P400164', name: 'Del Monte Whole Kernel Corn 15oz', brand: 'Del Monte', availability: 'in-stock', facings: 2, images: 2, emoji: '🌽' },
            { id: 'P400165', name: 'Del Monte Cream Style Corn 15oz', brand: 'Del Monte', availability: 'out-of-stock', facings: 0, images: 1, emoji: '🌽' },
            { id: 'P400166', name: 'Signature SELECT Whole Kernel Corn 15oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 3, images: 2, emoji: '🌽' },

            // Canned Green Beans
            { id: 'P400167', name: 'Del Monte Cut Green Beans 14.5oz', brand: 'Del Monte', availability: 'in-stock', facings: 2, images: 2, emoji: '🫘' },
            { id: 'P400168', name: 'Del Monte French Style Green Beans 14.5oz', brand: 'Del Monte', availability: 'in-stock', facings: 1, images: 2, emoji: '🫘' },
            { id: 'P400169', name: 'Green Giant Cut Green Beans 14.5oz', brand: 'Green Giant', availability: 'in-stock', facings: 3, images: 2, emoji: '🫘' },
            { id: 'P400170', name: 'Signature SELECT Cut Green Beans 14.5oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 1, images: 2, emoji: '🫘' },

            // Canned Carrots
            { id: 'P400171', name: 'Del Monte Sliced Carrots 14.5oz', brand: 'Del Monte', availability: 'in-stock', facings: 1, images: 2, emoji: '🥕' },
            { id: 'P400172', name: 'Signature SELECT Sliced Carrots 14.5oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 2, images: 2, emoji: '🥕' },

            // Canned Mixed Vegetables
            { id: 'P400173', name: 'Del Monte Mixed Vegetables 15oz', brand: 'Del Monte', availability: 'in-stock', facings: 2, images: 2, emoji: '🥗' },
            { id: 'P400174', name: 'Green Giant Mixed Vegetables 15oz', brand: 'Green Giant', availability: 'in-stock', facings: 4, images: 2, emoji: '🥗' },
            ...
            // Canned Beets
            { id: 'P400176', name: 'Del Monte Sliced Beets 14.5oz', brand: 'Del Monte', availability: 'in-stock', facings: 2, images: 2, emoji: '🥬' },
            { id: 'P400177', name: 'Del Monte Diced Beets 14.5oz', brand: 'Del Monte', availability: 'in-stock', facings: 4, images: 2, emoji: '🥬' },
            { id: 'P400178', name: 'Signature SELECT Sliced Beets 14.5oz', brand: 'Signature SELECT', availability: 'in-stock', facings: 1, images: 2, emoji: '🥬' },

            // Specialty Items
            { id: 'P400179', name: 'Mezzetta Garlic Cloves 8oz', brand: 'Mezzetta', availability: 'in-stock', facings: 4, images: 2, emoji: '🧄' },
            { id: 'P400180', name: 'Cento Garlic in Oil 8oz', brand: 'CENTO', availability: 'in-stock', facings: 3, images: 2, emoji: '🧄' },
            { id: 'P400181', name: 'Jeff\'s Naturals Garlic Stuffed Olives 7oz', brand: 'Jeff\'s Naturals', availability: 'in-stock', facings: 1, images: 2, emoji: '🫒' },
            { id: 'P400182', name: 'Peperoncino Calabrese Hot Peppers 10oz', brand: 'Tutto Calabria', availability: 'in-stock', facings: 1, images: 2, emoji: '🌶️' },
            { id: 'P400183', name: 'Mezzetta Italian Mix Giardiniera 16oz', brand: 'Mezzetta', availability: 'in-stock', facings: 3, images: 2, emoji: '🥗' },
            ...
            { id: 'P400185', name: 'Tillen Farms Crispy Dilly Beans 12oz', brand: 'Tillen Farms', availability: 'in-stock', facings: 3, images: 2, emoji: '🫘' },
            { id: 'P400186', name: 'Rick\'s Picks Mean Beans 15oz', brand: 'Rick\'s Picks', availability: 'in-stock', facings: 4, images: 2, emoji: '🫘' },
            { id: 'P400187', name: 'Wickles Wicked Okra 16oz', brand: 'Wickles', availability: 'in-stock', facings: 2, images: 2, emoji: '🌿' }
        ]
    },
    4: {
        id: 4,
